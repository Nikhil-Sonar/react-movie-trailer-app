...
function OnlyTvShowsData() {
    ...
    const TVShowScrollDataRender = (props) => {
        const reqObj = {
            method: 'GET',
            url: `https://api.themoviedb.org/3/discover/tv?page=${props}`,
    ...
    const handleScrollTv = () => {
        if ((window.innerHeight + document.documentElement.lastChild !== document.documentElement.offsetHeight) && isLoading) {
            return;
        } else {
            return (
...
export default OnlyTvShowsData;