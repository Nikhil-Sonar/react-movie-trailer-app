...
import "../SearchResultComp/SearchResult.scss"
...
function SearchResultDataRender() {
    ...
    const moviesscrollDataRender = (props) => {
        const reqObj = {
            method: 'GET',
            url: `https://api.themoviedb.org/3/search/multi?query=${SearchIdFetch}&page=${props}`,
      ...
      return (
        <div className="movies-parent">
            <div className="movie-body-container only-movies-Render">
                <p>Search results of {(cards == "") ? `'No Result fount for these Input...'` : `${SearchIdFetch}`}</p>
...
export default SearchResultDataRender;